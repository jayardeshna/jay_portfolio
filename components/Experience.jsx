  ...
  return (
    <div className=" mt-32 lg:mt-8 flex flex-col justify-start space-y-12 mx-auto items-center md:mt-20 lg:min-h-screen">
      ...
      <div className="w-[80%] mx-auto">
        <div className="text-center max-w-2xl mx-auto tracking-normal leading-5 text-base sm:text-[1.1rem] lg:text-lg text-justify">
      ...
      <div className="flex flex-col relative space-y-16 md:space-y-10 lg:space-y-8 items-center">
        <div className="drop-shadow-2xl flex flex-col space-y-4 mx-6 md:mx-20 lg:mx-0 md:w-[70%] lg:w-[80%] max-w-2xl">
          ...
          <div className="font-normal sm:text-[0.95rem] md:text-base text-center text-justify">
          My expertise spans across the modern Java ecosystem, including powerful backend frameworks like Spring Boot, Hibernate, and Apache Kafka, as well as cloud services such as AWS. On the front end, I excel in React.js, allowing me to engineer full-fledged applications from the ground up. This diverse skill set enables me to handle both the intricacies of front-end interactivity and the complexities of server-side logic with equal finesse, all while leveraging the scalability and reliability of AWS.
          </div>
        </div>
        <div className="drop-shadow-xl flex flex-col space-y-4 mx-6 md:mx-20 lg:mx-0 md:w-[70%] lg:w-[80%] max-w-2xl rounded-[1.4rem] p-4 rounded-tl-none">
          ...
          <div className="font-normal sm:text-[0.95rem] md:text-base text-center text-justify"  >
          As a problem solver, I excel in dissecting complex issues, identifying the root causes, and devising efficient, scalable solutions. My analytical thinking is complemented by a creative approach, allowing me to navigate challenges with innovation and precision. This skill set enables me to transform obstacles into opportunities for growth and improvement.
          </div>
        </div>
      ...
      <div className="w-[80%] max-w-2xl mx-auto">
        <div className="text-center font-normal mb-6 tracking-normal text-sm leading-5 sm:text-base lg:text-lg text-justify">
