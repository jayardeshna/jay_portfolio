  ...
  const data = [
    {
      ...
      org: "Brilworks Software",
      skills: ["Java", "Spring", "Springboot", "Hibernate", "AWS EC2", "AWS Lambda", "AWS S3"],
      class:
    ...
    },
    {
      ...
      org: "Synoptek India Pvt Ltd",
      skills: ["Java/J2EE", "Apache Tomcat", "Git", "BitBucket"],
      class:
    ...
    },
    {
      ...
      org: "Tatvasoft",
      skills: ["Javascript", "ReactJs", "NodeJs", "ExpressJs", "MongoDb", "PostgreSql"],
      class:
