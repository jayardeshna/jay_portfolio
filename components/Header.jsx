...
import logo from "@/public/logo_brand.png";
...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="flex md:space-x-10 lg:space-x-12 xl:space-x-16 md:flex items-center place-items-center justify-between py-3 md:px-10 px-8">
