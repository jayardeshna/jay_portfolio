  ...
  const data = [
    {
        ...
        id: 0,
        main: "/icons/java.svg",
        desc: "A multi-platform, object-oriented, and network-centric language that can be used as a platform in itself.",
        tag: "develop",
        bg: "bg-gray-900",
        text: "text-gray-50",
    },
    {
        title: "Spring",
        id: 1,
        main: "/icons/Spring.svg", // Assuming there is an icon for Spring
        desc: "A comprehensive framework for building enterprise-grade Java applications.",
        tag: "develop",
        bg: "bg-green-50",
        text: "text-green-500",
    },
    {
        title: "Hibernate",
        id: 2,
        main: "/icons/Hibernate.svg", // Assuming there is an icon for Hibernate
        desc: "An object-relational mapping tool for the Java programming language.",
        tag: "develop",
        bg: "bg-blue-50",
        text: "text-blue-500",
    },
    {
        ...
        desc: "A relational database that stores data in separate tables rather than putting all the data in one big storeroom.",
        tag: "Database",
        bg: "bg-gray-900",
        text: "text-gray-50",
    },
    {
        title: "PostgreSQL",
        id: 4,
        main: "/icons/PostgresSQL.svg", // Assuming there is an icon for PostgreSQL
    ...
    },
    {
        ...
        id: 9,
        main: "/icons/node.svg",
        desc: "An open-source, cross-platform JavaScript runtime environment and library for running web applications outside the client's browser.",
        tag: "develop",
        bg: "bg-gray-900",
        text: "text-gray-50",
    },
    {
        title: "Express.js",
        id: 10,
        main: "/icons/Express.svg", // Assuming there is an icon for Express.js
    ...
    },
    {
        ...
        desc: "A noSQL database with the scalability and flexibility that you want with the querying and indexing that you need.",
        tag: "Database",
        bg: "bg-gray-900",
        text: "text-gray-50",
    },
    {
        ...
        id: 12,
        main: "/icons/aws.svg",
        desc: "A service which allows application providers, ISVs, and vendors to quickly and securely host your applications.",
        tag: "platform",
        bg: "bg-gray-900",
        text: "text-gray-50",
    },
    {
        title: "AWS Lambda",
        id: 13,
        main: "/icons/lambda.svg", // Assuming there is an icon for AWS Lambda
        desc: "A serverless compute service that runs your code in response to events and automatically manages the underlying compute resources.",
        tag: "platform",
        bg: "bg-orange-50",
    ...
    },
    {
        title: "AWS S3",
        id: 14,
        main: "/icons/Simple Storage Service.svg", // Assuming there is an icon for AWS S3
    ...
    },
    {
        title: "AWS EC2",
        id: 15,
        main: "/icons/EC2.svg", // Assuming there is an icon for AWS EC2
        desc: "A web service that provides secure, resizable compute capacity in the cloud.",
        tag: "platform",
        bg: "bg-gray-900",
        text: "text-gray-50",
    },
    {
        ...
        id: 16,
        main: "/icons/Elastic Beanstalk.svg", // Assuming there is an icon for AWS Elastic Beanstalk
        desc: "An easy-to-use service for deploying and scaling web applications and services developed with various technologies.",
        tag: "platform",
        bg: "bg-gray-900",
        text: "text-gray-50",
    },
    {
        ...
        id: 17,
        main: "/icons/CloudWatch.svg", // Assuming there is an icon for AWS CloudWatch
        desc: "A monitoring and observability service built for DevOps engineers, developers, site reliability engineers (SREs), and IT managers.",
        tag: "platform",
        bg: "bg-gray-900",
        text: "text-gray-50",
    },
    {
        title: "AWS DynamoDB",
        id: 18,
        main: "/icons/DynamoDB.svg", // Assuming there is an icon for AWS DynamoDB
        desc: "A key-value and document database that delivers single-digit millisecond performance at any scale.",
        tag: "platform",
        bg: "bg-gray-900",
        text: "text-gray-50",
    },
    {
        title: "AWS Neptune",
        id: 19,
        main: "/icons/Neptune.svg", // Assuming there is an icon for AWS Neptune
        desc: "A fast, reliable, fully managed graph database service that makes it easy to build and run applications that work with highly connected datasets.",
        tag: "platform",
        bg: "bg-gray-900",
        text: "text-gray-50",
    },
    {
        title: "Git",
        id: 20,
        main: "/icons/Git.svg", // Assuming there is an icon for Git
    ...
    },
    {
      title: "Github",
      id: 21,
      main: "/icons/github-original.svg", // Assuming there is an icon for Git
      desc: "A Git repository management solution designed for professional teams.",
      tag: "platform",
      bg: "bg-gray-900",
      text: "text-gray-50",
  },
    {
        title: "Bitbucket",
        id: 22,
        main: "/icons/BitBucket.svg", // Assuming there is an icon for Bitbucket
        desc: "A Git repository management solution designed for professional teams.",
        tag: "platform",
        bg: "bg-gray-900",
        text: "text-gray-50",
