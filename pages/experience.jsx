...
export default function Experience() {
    ...
    return (
        <div className="px-10 sm:px-20 md:px-32 lg:mb-12 lg:px-60 mx-auto max-w-[75rem]">
            <Head>
                <title>Jay Ardeshna ✦ Experience</title>
                ...
                <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
                    <div className=" mx-auto flex flex-col ">
                        ...
                        <p className="mt-8 max-w-xl text-center md:w-[70%] mx-auto text-sm md:text-base lg:text-xl mb-2 px-2">
                            Transforming ideas into reality with a passion for innovative software solutions.
                        </p>
                    ...
                    <div className="text-[0.92rem] text-base mx-12 font-light dark:text-white text-gray-900">
                        <div className="mt-6 mb-12 font-normal text-justify">
                            <p className="text-gray-400 select-none font-semibold mb-1 dark:text-white/30">
                                Software Developer
                            </p>
                            <p>• Implemented secure and efficient uploading of audio files to Amazon S3 by generating presigned URLs, enabling temporary access and handling large file uploads with multipart uploads.</p>
                            <br />
                            <p>• Utilized Python’s Pydub library to manipulate audio files by performing operations such as trimming, concatenation, volume adjustment, and applying effects like fades and overlays.</p>
                            <br />
                            <p>• Integrated AudoAI for enhancing audio quality by automating noise reduction and other audio improvements through third-party API integration.</p>
                            <br />
                            <p>• Enabled exporting of manipulated audio files in various formats (MP3, WAV, OGG) and facilitated downloading, ensuring compatibility and maintaining audio quality across different devices and platforms.</p>
                            <br />
                            <p>• Created and maintained RSS feeds for distributing podcast episodes, ensuring compliance with requirements of major podcast platforms like Apple Podcasts and Spotify, and automating the publishing process for new episodes.</p>
                            <br />
                            <p>• Integrated Stripe for handling secure payment processing, managing subscriptions, and handling billing and invoicing, ensuring compliance with PCI DSS standards and providing a seamless payment experience for premium content.</p>
                        </div>
                    </div>
                    ...
                    <div className=" text-[0.92rem] text-base mx-12 font-light dark:text-white text-gray-900">
                        ...
                        <p className="mt-6 mb-12 font-normal text-justify">
                            <p className="text-gray-400 select-none font-semibold mb-1 dark:text-white/30 ">
                                Java Developer
                            </p>
                            • Worked on a comprehensive dental project within the healthcare sector, This project aimed to enhance patient management and streamline operations through advanced technological solutions.
                            <br /><br />
                            • Integration of RCOPIA for electronic prescribing with existing patient records, ensuring secure and accurate data exchange.
                            <br /><br />
                            • Developed robust APIs using Java Servlets and Hibernate for patient registration, login, and management of medical histories, optimizing database interactions and enhancing data security.
                            <br /><br />
                            • Proficient in leveraging Flashcodes for medical applications, enhancing data accessibility and streamlining information retrieval processes within healthcare systems.
                            <br /><br />
                            • Engaged in research and exploration of AI technologies for the automatic generation of prescriptions for patients, aiming to enhance efficiency and accuracy in healthcare delivery processes.
