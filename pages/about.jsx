...
export default function About() {
  ...
  return (
    <div className="px-10 sm:px-20 md:px-32 lg:mb-12 lg:px-60 mx-auto max-w-[75rem]">
      <Head>
        <title>Smit Bhalani ✦ About</title>
      ...
      <main className="  max-w-screen ">
        <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
          ...
          <div className=" text-[0.92rem] text-base mx-12 font-light dark:text-white text-gray-900">
            ...
            I am a passionate Full Stack Developer with 2 years of experience in crafting seamless web applications using Java, React, and AWS. I thrive on delivering high-quality solutions that cater to your business needs. <span className="inline-flex items-baseline">
                <Image
                  src={Rocket}
                  alt="rocket"
              ...
              • 💻 Java Development: Expertise in building robust backend systems and APIs with Java, mastering frameworks like Spring Boot, Hibernate, and creating efficient RESTful services.
              <br /><br />
              • 🚀 Node.js Expertise: Proficient in developing server-side applications with Node.js, utilizing its event-driven architecture for high-performance and scalable solutions.
              <br /><br />
              • ✨ React Wizardry: Skilled in designing dynamic and responsive front-end applications with React, ensuring a smooth user experience with state-of-the-art component-based architecture.
              <br /><br />
              • ☁️ AWS Proficiency: Competent in deploying and managing applications on AWS, leveraging services like EC2, S3, RDS, and Lambda to guarantee top-notch performance and scalability.
              <br /><br />
              • 🌟 Flutter Flow: Specializing in creating visually appealing and functional mobile apps using Flutter Flow’s intuitive drag-and-drop interface, allowing for rapid prototyping and deployment.
            ...
            <p className="">
              ...
              <a
                onClick={() =>
                  navigator.clipboard.writeText("jayardeshna.uw@gmail.com")
                }
